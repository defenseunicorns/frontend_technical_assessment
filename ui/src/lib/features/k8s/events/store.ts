...
export const noEventsMsg =
  'Cluster events from the last hour will appear here. An empty log often indicates healthy cluster performance.'
...
export function createStore(): ResourceStoreInterface<Resource, Row> {
  ...
  const noResourcesMsg = {
    ...
    titleStyle: 'text-lg text-gray-100 mb-2',
    msg: noEventsMsg,
    msgStyle: 'text-sm font-normal text-gray-400 mb-8',
  }
